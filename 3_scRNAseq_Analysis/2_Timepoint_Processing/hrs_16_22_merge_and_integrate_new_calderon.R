...
# ────────────────────────────────────────────────────
seurat_obj_1 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_16_22_A8_Rep1/2_hrs_16_22_A8_Rep1_preprocessed.qs"))
seurat_obj_2 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_16_22_A16_Rep2/2_hrs_16_22_A16_Rep2_preprocessed.qs"))

sample_name_1        <- "hrs_16_22_A8_Rep1"
sample_name_2        <- "hrs_16_22_A16_Rep2"
sample_name_main     <- "hrs_16_22"
sample_name          <- sample_name_main 

optimal_pcs               <- 94  
chosen_resolution         <- 1.5  # clustering before Harmony
...
bdgp_file  <- file.path(file_path2, "Annotation_Tables/insitu_annot_hrs_16_22.csv")
