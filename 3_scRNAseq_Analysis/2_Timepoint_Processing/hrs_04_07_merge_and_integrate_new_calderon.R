...
# ────────────────────────────────────────────────────
seurat_obj_1 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_04_07_A3_Rep1/2_hrs_04_07_A3_Rep1_preprocessed.qs"))
seurat_obj_2 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_04_07_A11_Rep2/2_hrs_04_07_A11_Rep2_preprocessed.qs"))

sample_name_1        <- "hrs_04_07_A3_Rep1"
sample_name_2        <- "hrs_04_07_A11_Rep2"
sample_name_main     <- "hrs_04_07"
sample_name          <- sample_name_main 

optimal_pcs               <- 100   # updated later by determine_pcs()
chosen_resolution         <- 2.4  # clustering before Harmony
chosen_resolution_harmony <- 2.1  # clustering after  Harmony
...
bdgp_file  <- file.path(file_path2, "Annotation_Tables/insitu_annot_hrs_04_07.csv")
