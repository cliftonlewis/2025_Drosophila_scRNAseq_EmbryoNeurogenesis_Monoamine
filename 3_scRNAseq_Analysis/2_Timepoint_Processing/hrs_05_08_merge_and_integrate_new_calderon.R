...
# ────────────────────────────────────────────────────
seurat_obj_1 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_05_08_A4_Rep1/2_hrs_05_08_A4_Rep1_preprocessed.qs"))
seurat_obj_2 <- qread(paste0("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_05_08_A12_Rep2/2_hrs_05_08_A12_Rep2_preprocessed.qs"))

sample_name_1        <- "hrs_05_08_A4_Rep1"
sample_name_2        <- "hrs_05_08_A12_Rep2"
sample_name_main     <- "hrs_05_08"
sample_name          <- sample_name_main 

optimal_pcs               <- 64   # updated later by determine_pcs()
chosen_resolution         <- 2.2  # clustering before Harmony
...
bdgp_file  <- file.path(file_path2, "Annotation_Tables/insitu_annot_hrs_05_08.csv")
