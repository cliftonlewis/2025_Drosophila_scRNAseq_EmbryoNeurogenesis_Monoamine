...
# ────────────────────────────────────────────────────
seurat_obj_1 <- qread("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_00_03_A1_Rep1/2_hrs_00_03_A1_Rep1_preprocessed.qs")
seurat_obj_2 <- qread("../Step_2.1_Sample_preprocessing/Data/Timepoint_Datasets/hrs_00_03_A9_Rep2/2_hrs_00_03_A9_Rep2_preprocessed.qs")

sample_name_1        <- "hrs_00_03_A1_Rep1"
sample_name_2        <- "hrs_00_03_A9_Rep2"
sample_name_main     <- "hrs_00_03"
sample_name          <- sample_name_main 

optimal_pcs               <- 45  
chosen_resolution         <- 2.2  # clustering before Harmony
chosen_resolution_harmony <- 2.6  # clustering after  Harmony
...
bdgp_file  <- file.path(file_path2, "Annotation_Tables/insitu_annot_hrs_00_03.csv")
